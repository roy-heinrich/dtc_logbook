<x-guest-layout>
    <form method="POST" action="{{ route('register') }}" data-loading-overlay="true" data-loading-text="Creating your account..." data-loading-button-text="Registering...">
        @csrf
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <x-primary-button class="ms-4">
                <span data-submit-text>{{ __('Register') }}</span>
            </x-primary-button>
        </div>
    </form>
</x-guest-layout>
