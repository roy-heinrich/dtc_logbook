...
<div class="mx-auto max-w-2xl space-y-6">
    <div>
        <h1 class="text-2xl font-bold text-slate-900 dark:text-white">Add New Admin</h1>
        <p class="mt-1 text-sm text-slate-600 dark:text-slate-400">Create a new administrator account</p>
    </div>
