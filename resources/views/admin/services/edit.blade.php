...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <h1 class="text-2xl font-bold text-slate-900 dark:text-white">Edit Service</h1>
    ...
    <div class="rounded-xl glass-card p-6 shadow-sm">
        <h2 class="text-base font-semibold text-slate-900 dark:text-white">Service Details</h2>
        ...
        <form action="{{ route('admin.services.update', $service) }}" method="POST" class="mt-4 flex flex-col gap-4">
            @csrf
            @method('PUT')
            <div>
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="{{ route('admin.services.index') }}" class="text-sm font-medium text-slate-600 hover:text-slate-800 dark:text-slate-300 dark:hover:text-slate-100">
                    Cancel
                </a>
            </div>
        </form>
